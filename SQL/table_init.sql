...
--OPC项
INSERT INTO t_plc_opcitem (item_id, opcgroup_id, field_name, enabled) VALUES ('[R1_TOPIC]WRHLongTravelLocationFromGPS', 1, 'WalkingPosition', 1);
INSERT INTO t_plc_opcitem (item_id, opcgroup_id, field_name, enabled) VALUES ('[R1_TOPIC]WRHBoomLuffAngleGPS', 1, 'PitchAngle', 1);
INSERT INTO t_plc_opcitem (item_id, opcgroup_id, field_name, enabled) VALUES ('[R1_TOPIC]WRHBoomSlewAngleGPS', 1, 'YawAngle', 1);
INSERT INTO t_plc_opcitem (item_id, opcgroup_id, field_name, enabled) VALUES ('[R1_TOPIC]ENCODER_DATA[2]', 1, 'WalkingLeft_Plc', 1);
INSERT INTO t_plc_opcitem (item_id, opcgroup_id, field_name, enabled) VALUES ('[R1_TOPIC]ENCODER_DATA[3]', 1, 'WalkingRight_Plc', 1);
...
INSERT INTO t_plc_opcitem (item_id, opcgroup_id, field_name, enabled) VALUES ('[R1_TOPIC]Local:4:I.Data[18]', 1, 'YawSpeed_Plc', 1);
