    ...
    public class ClusterGeneral : SensorMessage
    {
        ...
        private void DataConvert(string binary)
        {
            try
            {
                ...
                //this.dist_long = Math.Round(0.2 * Convert.ToUInt16(binary.Substring(8, 13), 2) - 500, 1);
                //this.dist_lat = Math.Round(0.2 * Convert.ToUInt16(binary.Substring(22, 10), 2) - 102.3, 1);
                //this.CalculateConvertedCoors();
