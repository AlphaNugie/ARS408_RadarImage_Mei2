...
namespace ARS408.Forms
{
    public partial class FormRadar : Form
    {
        ...
        private void Button_Add_Click(object sender, EventArgs e)
        {
            ...
            object[] values = new object[] { 0, string.Empty, string.Empty, 20001, this.first_group_id, this.first_mode_id, "0", BaseConst.IpAddress_Local, 20005, 0, 0, 0, 0, this.first_direction_id, this.first_defense_mode_id, 0, 0, 0, 0, BaseConst.RcsMinimum, BaseConst.RcsMaximum, 0, 1, 1, string.Empty };
